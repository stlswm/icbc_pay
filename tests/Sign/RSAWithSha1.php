 ...
 * @package tests\Sign
 */
class RSAWithSha1 extends TestCase
{
    /**
     * @throws \Exception
     */
    public function testSHA1withRSA()
    {
        ...
        $sign = \stlswm\IcbcPay\Sign\RSAWithSha1::signStr($str, $privateCertC);
        $this->assertSame('CALafK6MYqqH132SVshTHagUu1myKfajvqchRGLjGpQalwhK3EYkgjzdcSYMz4KvzAEcrZcqC9oiYJ5sPdJ9JA3bhguvlxQgEJTNlYEvzBwCaAPd7DD6hFoe1AJixwfRKg+J1SJNjdEJfxXdu7/bY526M7+W+yCUTvGNWMuKCC8=',
            $sign);
    }
}